...
function apnSocketLegacy(connection, socketOptions, connected) {
	...
	/* Start - Fixation socket got disconnect after some time - TODO 15 Jan 2016 - anas
	...
	socketOptions.socket.setTimeout(0);// no time out
    socketOptions.socket.setNoDelay(true);
    socketOptions.socket.setKeepAlive(true, 0);
    //End 
...
function apnSocket(connection, socketOptions, connected) {
	...
	socket.setTimeout(0);// no time out
