...
//    var sockets =[];
    ...
    io.sockets.on('connection', function(socket){
        ...
        socket.on('chat', function (username,to_username,status) {
            //socket.username=username; //ODO-Imp - Commented on 15 Dec 2015 For socket disconnect issue while screen switching
...
//                        console.log(socketClientId);
    ...
    //                                    console.log("arguments", arguments);
                                ...
                                // TODO - 'updatechat' updated with 'updatechat_chatlog'  and 'io.of('/Chat')' with io - anas - 14 oct 2015
                                io.to(roomname).emit("updatechat_chatlog",from_user,data); // TODO-Imp 15 Dec 2015  socket.username replace with from_user
                            }
                        }   
                    }
