 ...
 * @description Usage: http://52.11.98.82:3000/signup <p>Form will be POST whose type is multipart/form-data</p>
 * <p>METHOD: POST</p>
 */
       ...
       // picTableData['user_id']=data.user_id;
        ...
        connection.query(insertQuery, picTableData, function(err,result){
            ...
            if(!err){
                ...
                output["Pic_Path"] = "http://52.11.98.82:3000/"+data.pic_path+data.pic_name;
