...
//     io.of('/').on('connection', function (socket) {
    ...
    io.sockets.on('connection', function (socket) {
        ...
        // TODO-Imp -- test event for debuging screen switching disconnecting issue --- 15 Dec 2015
        socket.on('test', function(str){
          console.log('test Result called succesfully with provided string '+ str);
            io.sockets.emit('testResult', 'test Result called succesfully with provided string '+ str);
        });
                                    ...
                                    deleteUserFromJsonDB(1,socket.room,socket.username,function(d_response){
                                        ...
                                        deleteUserFromJson(1,socket.room,othUsr,function(d_response){
                                            ...
                                            if(otherUser_soc){
                                                ...
                                                onsole.log('On restartGamePlay -> otherUser_soc.leave(socket.room) called ...'); //TODO
                                            }
                                            if(user_soc){
