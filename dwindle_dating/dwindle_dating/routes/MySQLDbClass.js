 ...
 */
//DB connect live configurations - anas - 31 aug 2015 - TODO-Imp DB Change - uncomment live settings and comment local settings before deployment
/*var MySQLDbClass={
    db_config:{
        host: 'localhost',
		user: 'root',
		password: 'dwindle2868',//AWS = dwindle21212
