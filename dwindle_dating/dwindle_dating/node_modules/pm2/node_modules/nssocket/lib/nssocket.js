...
NsSocket.prototype.setIdle = function setIdle(time) {
  /* Start - Fixation socket got disconnect after some time - TODO 20 Jan 2016 - anas - 'this.socket.setTimeout(time)' replced with 'this.socket.setTimeout(0)'
...
NsSocket.prototype._onIdle = function _onIdle() {
  this.emit('idle');
  if (this._timeout) {
    /* Start - Fixation socket got disconnect after some time - TODO 20 Jan 2016 - anas - 'this.socket.setTimeout(this._timeout)' replced with 'this.socket.setTimeout(0)'
