 ...
 * @description Usage: http://52.11.98.82:3000/add_user_picture <p>Form will be POST whose type is multipart/form-data</p>
 * <p>METHOD: POST</p>
 */
        ...
        var dumpDataIntoDb = function(data,res,username){
            ...
            connection.query(insertQuery, data, function(err,result){
                ...
                if(!err){
                    ...
                    output["Pic_Path"] = "http://52.11.98.82:3000/"+data.pic_path;
