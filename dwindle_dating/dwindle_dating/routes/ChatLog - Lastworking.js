...
//                        console.log(socketClientId);
                    ...
                    for(var i=0;i<usersAttendingInRoom.length;i++){
                        ...
                        {   // start - throw in app notification if user is not on screen but available online ---  anas - 6 Oct 2015
                            ...
                            if (mainSocket) {
                                mainSocket.emit('message_from_matches_screen', 'Event : message_from_matches_screen          Message : ' + data, from_user, 'MatchesScreen', chatUserName, 'chat');// chatUserName, 'chat' added on 13 De 2015 // TODO-Imp remove 'Event : message_from_matches_screen          Message : ' 
                                insertChatLogToDB(1, from_user, to_user, fullDate,fullTime ,data, msgStatus,roomname,function (getResult) {
                                });
                            }//end - anas - 7 Oct 2015
                            else{
...
//                }
        ...
        socket.on('disconnect',function(){
            ...
            connection.query(sql, function (sqlerr, result) {
                ...
                console.log('Chat -> ----- disconnect --------> delete user[socket.username] called');// 
                //delete user[socket.username];
            });
            //console.log(roomname);*/

            console.log('Chat log updated -> ----- disconnect --------> socket.leave(roomname); called');// 
